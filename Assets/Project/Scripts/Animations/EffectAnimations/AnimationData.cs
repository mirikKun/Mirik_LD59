...
namespace Project.Scripts.Animations.EffectAnimations
{
    ...
    public class AnimationData
    {
        ...
        [Header("Delays")] [SerializeField] private float _delayBefore = 0f;
        [SerializeField] private float _delayAfter = 0f;

        [Header("Play Mode")] [SerializeField] private AnimationPlayMode _playMode = AnimationPlayMode.Sequential;
